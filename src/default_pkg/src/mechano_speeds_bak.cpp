...
/*-------Function Prototypes-------*/
void mechanoCallback(const std_msgs::Int16::ConstPtr& msg);
...
//	labhUtil util(mechanumIdent);

/*
	std::string port = util.getUSBloc();
	if (port.compare("") == 0)
	{
		ROS_INFO("exit");
		return 0;
...
/*-------MechanumCallback----------*/
void machanumCallback()//const std_msgs::Int16::ConstPtr& msg)
{
